...
В файле [scrobbles.txt](./files/scrobbles.txt) вперемешку представлена история прослушивания Маши за некоторый промежуток времени.
...
Строки файла [encryped.txt](./files/encryped.txt) "зашифрованы": записаны задом наперёд.
