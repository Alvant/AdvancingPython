...
Взаимодействие между кругами можно "задвинуть": будем считать, что круги друг на друга никак не влияют.
...
А вот если за брусками ещё была расположена "интересная" картинка, которую очень хотелось бы открыть, то градус игры моментально повышался...[^xonix]

Реализуйте с помощью `pygame` игру с постепенно открывающейся картинкой!
Предлагается немного упростить механику по сравнению с Arkanoid-ом и сделать следующим образом.
...
Единственные условия — чтобы 1) было "осмысленно", 2) что-то двигалось по экрану или "пропадало"/"появлялось" (в общем, "динамичность" в каком-то виде) и 3) использовались сигналы.
...
[^xonix]: Описанную игру со скрытой картинкой найти не получилось, поэтому точных ссылок нет. Но что-то такое точно было на старых телефонах) Чтобы это хоть как-то подтвердить, можно привести в пример другую игру [Xonix](https://playminigames.net/game/xonix). У неё тоже есть "более интересная" версия, называется SeXoniX (при желании можно спокойно найти)...
