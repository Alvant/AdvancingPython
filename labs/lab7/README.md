...
В файле <a href="./files/D2/f.txt">f.txt</a> приведены значения функции $f$ в формате `x -> y`.
А в файле <a href="./files/D2/g.txt">g.txt</a> приведены значения функции $g$ в формате `y -> z`.
