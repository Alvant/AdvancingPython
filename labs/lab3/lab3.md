...
На основе кода как в [первой задаче про черепашек](#задача-ч1-газ-из-черепашек) сделайте так, чтобы черепашки проводили "ритуал вызова Ктухлу": каждая черепашка идёт по своей окружности около общего центра, по часовой стрелке, рисуя линию; все черепашки двигаются с одинаковой линейной скоростью.
