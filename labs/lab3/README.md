...
В текстовом файле — например, в файле [LF5.txt](./files/LF5.txt) — дан список чисел: первая строка — количество чисел $n$, и далее по числу на каждой из следующих $n$ строк.
...
В текстовом файле — например, в файле [LF6.txt](./files/LF6.txt) — дан список чисел: первая строка — количество чисел $n$, и далее по числу на каждой из следующих $n$ строк.
...
В текстовом файле — например, в файле [LF8.txt](./files/LF8.txt) — дан список чисел: первая строка — количество чисел $n$, и далее по числу на каждой из следующих $n$ строк.
*Все числа различны*.
