...
В текстовом файле — например, в файле *СФ5.txt* из [папки с файлами по этому ДЗ](./files) — дан список чисел: первая строка — количество чисел $n$, и далее по числу на каждой из следующих $n$ строк.
...
В текстовом файле — например, в файле *СФ6.txt* из [папки с файлами по этому ДЗ](./files) — дан список чисел: первая строка — количество чисел $n$, и далее по числу на каждой из следующих $n$ строк.
...
В текстовом файле — например, в файле *СФ8.txt* из [папки с файлами по этому ДЗ](./files) — дан список чисел: первая строка — количество чисел $n$, и далее по числу на каждой из следующих $n$ строк.
*Все числа различны*.
