...
В текстовом файле — например, в файле [СФ5.txt](../labs/lab3/files/СФ5.txt) — дан список чисел: первая строка — количество чисел $n$, и далее по числу на каждой из следующих $n$ строк.
...
В текстовом файле — например, в файле [СФ6.txt](../labs/lab3/files/СФ6.txt) — дан список чисел: первая строка — количество чисел $n$, и далее по числу на каждой из следующих $n$ строк.
...
В текстовом файле — например, в файле [СФ8.txt](../labs/lab3/files/СФ8.txt) — дан список чисел: первая строка — количество чисел $n$, и далее по числу на каждой из следующих $n$ строк.
*Все числа различны*.
