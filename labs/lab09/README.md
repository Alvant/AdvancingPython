...
И вчера вечером, перед сном, она подумала об авторе <a href="../lab05/README.md#задача-6-послание">послания</a>: знает ли он, когда у неё день рождения? готовится ли что-то сделать для неё в этот день? что-то подарить или, может, даже "раскрыться", перестать быть анонимом?..
