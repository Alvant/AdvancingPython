...
В качестве ДЗ достаточно решить четыре задачи: одну по ветвлению (if-else), одну по циклам (for/while), одну по функциям (def) и одну по Черепахе.

А решение тоже надо [*залить в свой репозиторий на Гитхабе*](../docs/git-how-to)!
...
Если год является високосным, то надо вывести `"YES"`, иначе выведите `"NO"`.
(Год является високосным, если его номер кратен 4, но не кратен 100, а также если он кратен 400.)
```python
year = 2023

# Код с if-else, в результате исполнения которого выводится строка "NO"
```
...
# Код с if-else конструкциями. Результат: -10
```


### Задача В3 (Что надеть?)
...
Помогите Маше — напишите программу, которая в зависимости от погоды даст ей правильную рекомендацию по тому, в чём (или с чем) стоит идти сегодня на улицу.
...
У Маши есть такая традиция: летом она красит волосы в <span style="color: #7f00a6;">фиолетовый</span> цвет ("violet"), осенью в <span style="color: #021199;">синий</span> ("blue"), зимой в <span style="color: #b00000;">красный</span> ("red"), а весной в <span style="color: #f2f2f2;">белый</span> ("white").
